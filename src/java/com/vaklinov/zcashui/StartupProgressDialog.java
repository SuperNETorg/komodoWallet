...
// Taken from repository https://github.com/zlatinb/komodo-swing-wallet-ui under an MIT license
...
//        }
        ...
        System.out.println("checking if komodod is already running...");
        ...
        if (!shouldStartZCashd) {
            System.out.println("komodod already running...");
            // What if started by hand but taking long to initialize???
//            doDispose();
//            return;
        } else
        {
        	System.out.println("komodod will be started...");
        }
            ...
            public void run() {
                ...
                try
                {
	                ...
	                if (StartupProgressDialog.this.isAlive(daemonProcess)) {
	                        ...
	                        //System.out.println("komodod is still alive, killing forcefully");
    ...
    private void performOSXBundleLaunch() throws IOException, InterruptedException {
        ...
        File bundlePath = new File(System.getProperty("komodo.location.dir"));
